...
### OpenClaw sync
- **Correction:** Preserve markdown escaping and exact wording when mirroring repo docs into workspace files.
- **Context:** Syncing the openclaw clone into `workspace-local`
- **Count:** 1
