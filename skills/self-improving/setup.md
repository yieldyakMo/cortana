...
If the workspace already includes a local `proactivity/` tree, keep using it as the working state and reconcile the files there instead of recreating them.
