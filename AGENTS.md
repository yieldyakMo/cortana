...
3. Read up to 3 matching files from `~/self-improving/domains/`
4. If a project is clearly active, also read `~/self-improving/projects/<project>.md`
5. Do not read unrelated domains "just in case"

If inferring a new rule, keep it tentative until human validation.

Before non-trivial work or proactive follow-up:
